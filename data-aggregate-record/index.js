...
function createHtmlStringFromJson(retreivedData){
    ...
    html_string+='<tr>\n';
    for(var attribute in retreivedData[0]){
        if(typeof retreivedData[0][attribute]!=='object'){
            html_string+='<td>'+attribute+'</td>\n';
        }
    }
    html_string+='</tr>\n';
    retreivedData.forEach(function(object){
        html_string+='<tr>\n';
